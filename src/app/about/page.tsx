...
export const metadata: Metadata = {
  title: "Về EOfficial Tutor AI - Excel Add-in AI cho người Việt",
  description: "Tìm hiểu về sứ mệnh dân chủ hóa kiến thức Excel thông qua Excel Add-in AI của EOfficial Tutor AI. Chúng tôi giúp bạn hiểu thuật toán và hàm Excel.",
  alternates: {
    canonical: "/about",
  },
  openGraph: {
    title: "Về EOfficial Tutor AI - Excel Add-in AI thông minh",
